...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select().apis(RequestHandlerSelectors.basePackage("be.fooda.backend.store")).paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo())
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Fooda Store API", "Provides store information.", "1.0", "Terms of service",
