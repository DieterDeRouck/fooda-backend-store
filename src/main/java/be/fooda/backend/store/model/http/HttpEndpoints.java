...
public class HttpEndpoints {
    ...
    public static final String PRODUCTS_FIND_BY_ID_TEXT = "find/one/{storeId}";
    public static final String PRODUCTS_FIND_EXISTS_BY_ID_TEXT = "exists/one/{storeId}";
    public static final String PRODUCT_EXISTS_BY_UNIQUE_FIELDS = "exists/one/unique/";
    public static final String PRODUCTS_PUT_SINGLE_TEXT = "update/one/{storeId}";
    public static final String PRODUCTS_DELETE_BY_ID = "delete/one/passive/{storeId}";
    public static final String PRODUCTS_DELETE_BY_ID_PERMANENTLY = "delete/one/permanent/{storeId}";
